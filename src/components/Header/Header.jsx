      ...
      <div className="header_third">
        ...
        >
          <div className='header_third1'>
            ...
            {localStorage.getItem('userLoggedIn')=="aditya"? (<><span className='welcome'>Welcome Hemant</span><button onClick={()=>localStorage.removeItem('userLoggedIn')}><Link to={'/'}>Logout</Link></button></>)
