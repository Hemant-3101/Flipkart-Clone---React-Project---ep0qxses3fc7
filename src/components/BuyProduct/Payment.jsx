            ...
            <MDBCardBody className="mx-1 my-2">
              <div className="d-flex align-items-center">
                ...
                <div>
                  <p className="d-flex flex-column mb-0">
                    <b>Hemant kumar</b>
                    <span className="small text-muted">**** 7057</span>
                  </p>
                </div>
              </div>
              <div className="pt-3">
                <div className="d-flex flex-row pb-3">
                  ...
                  >
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <h6 className="mb-0 text-primary">₹245</h6>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="d-flex justify-content-between align-items-center pb-1">
                <a href="#!" className="text-muted">
                  ...
                  <div>
                <MDBBtn size="lg" onClick={()=>setPurchased(true)} >Pay amount</MDBBtn>
                <Link to={"/"}>
                <Modal open={purchased} footer={null} >
                  You have successfully purchased🎉🎉🎊🎊
                  <br/><br/>
                  <button style={{padding: "5px 25px 5px 25px"}} onClick={handlePayment}>Done</button>
                </Modal>
                </Link>
                </div>
              </div>
